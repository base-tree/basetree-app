        ...
        >
          ...
          >
            <Flex align={"center"} gap={4} w={"100%"}>
              <AvatarSvg
                styles={{
                  width: styles?.size === "sm" ? "44px" : "60px",
                  height: styles?.size === "sm" ? "44px" : "60px",
                }}
              />
            ...
            <Flex flexDir={_content.username.length > 10 ? 'column' : 'row'} >
            {styles?.size === "sm" && (
              <NumberIcon
                text={_content.stats.gamesPlayed.toString()}
                icon={<LinkIcon type="game" size={styles?.size === "sm" ? "26px" : notMobile ? "40px" : "32px"} />}
                tip="games played"
              />
            )}
            ...
            {styles?.size !== "lg" && (
              <NumberIcon
                ...
                icon={<LinkIcon type="trophy" size={styles?.size === "sm" ? "26px" : notMobile ? "40px" : "32px"} />}
                tip="total trophies"
              />
            )}
            </Flex>
                      ...
                      <Stack gap={6}>
                        ...
                        {_content.rarestTrophies && (
                          <>
                            ...
                            <TrophyMilestonesSlider
                              trophies={_content.rarestTrophies.filter(
