...
const LinkIcon = ({
  ...
  switch (type) {
    ...
    case "swap box":
      return line ? (
        <Icons.RiSwapBoxLine size={size} color={color ? color : undefined} />
      ) : (
        <Icons.RiSwapBoxFill size={size} color={color ? color : undefined} />
      );
    case "token chart":
      return line ? (
        <Icons.RiLineChartLine size={size} color={color ? color : undefined} />
      ) : (
        <Icons.RiLineChartFill size={size} color={color ? color : undefined} />
      );
    case "trophy":
    case "trophies":
      return line ? (
