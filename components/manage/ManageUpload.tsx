    ...
    if (e) {
      try {
        ...
        toast({
          ...
          description:
            "Please check your network and Try Again, If the problem presists, please send a message to basetree.xyz@gmail.com",
          isClosable: true,
        });
        setIsLoading(false);
        //// console.log(error);
  ...
  return (
    <Flex flexDirection="column" gap={4}>
      ...
      {type.includes("image") ? (
        ...
        >
          <LinkIcon type={isSuccess ? "RiCheckDoubleLine" : "RiUploadCloudLine"} size="24" />{" "}
          {isSuccess ? "Upload Successful" : "Upload Document"}
        </Button>
      )}
      {progress.total > 0 && (
        <Progress
