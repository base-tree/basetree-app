...
export const avatarSizeAtom = atom('md');
export const nftsNetworkAtom = atom('base');
...
export const headerColorAtom = atom('#00000000');
...
export const showOnChainScoreAtom = atom<boolean>(true);
export const showSocialProfilesAtom = atom<boolean>(true);
export const scoreTypeAtom = atom<string>('modal');
export const onchainScoreTypeAtom = atom<string>('modal');
