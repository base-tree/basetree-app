...
const Privacy: NextPage = () => {
  ...
  const des = 'BaseTree Privacy Policy';
  return (
    <>
        ...
        <Container as="main" maxW="container.lg" display="grid" minH="94vh" py={20}>
          <Flex flexDirection="column" maxW={'container.lg'}>
            <Stack fontSize={'xl'} gap={8}>
              ...
              <Text>
                Cookies and Tracking Technologies: BaseTree may use cookies and similar tracking
              ...
              <Text>
                Data Security: While BaseTree takes reasonable measures to protect the information
                stored on IPFS servers, please be aware that information stored on the blockchain
                and IPFS is inherently public and transparent. BaseTree cannot guarantee the
                security or confidentiality of any information shared on the platform.
              </Text>
              <Text>
                Third-Party Links: The BaseTree website may contain links to third-party websites or
