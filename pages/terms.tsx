...
const Terms: NextPage = () => {
  ...
  const des = 'BaseTree Terms of Use';
  return (
    <>
        ...
        <Container as="main" maxW="container.lg" display="grid" minH="94vh" py={20} >
          <Flex flexDirection="column" maxW={'container.lg'}>
            <Stack fontSize={'xl'} gap={8}>
              ...
              <Text><strong>
                Acceptance of Terms: </strong>By accessing and using the BaseTree website, you agree to be
                bound by these Terms of Use.
              </Text>
              <Text>
                Service Description: BaseTree is a decentralized platform built on the Base
              ...
              <Text>
                ...
                share on BaseTree. You agree not to use the service for any illegal or unauthorized
                purposes and to comply with all applicable laws and regulations.
              </Text>
              <Text>
                Intellectual Property: BaseTree retains all rights to its intellectual property,
                including trademarks, logos, and website content. You may not use or reproduce any
                of BaseTree's intellectual property without prior written permission.
              </Text>
              <Text>
                Limitation of Liability: BaseTree is not liable for any damages or losses resulting
