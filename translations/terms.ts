...
const terms: Terms = {
  ...
  feature5d: {
    en: 'Establish a secure and verifiable digital identity on the Base Blockchain.',
  },
  feature6: {
    en: 'Tradeable Asset',
  },
  feature6d: {
    en: 'Unlock the potential value of your BaseTree as a tradable digital asset.',
  },
  feature7: {
  ...
  watis: {
    en:"BaseTree brings a new level of personalization to the Base Blockchain, allowing users and dApps to assign human-readable names to Base addresses.",
  },
  wat2: {
    en: 'BaseTree Profile',
  },
  watis2: {
    en: ' Connect your profile to the PSN network, showcase your game achievements, and create a custom landing page with your favorite links, NFTs, and assets, all in one place.'
  },
  watis21: {
    en: 'wallet addresses',
  },
  ...
  nsDescription: {
    en: 'easily assign human-readable names to your Base Blockchain address',
  },
  manage: {
    en: 'manage',
  },
  ...
  claimDescription: {
    en: 'Build Your Web3 Profile in Minutes',
  },
  claimButton: {
    en: 'Register Domain',
  },
  ...
  dappDescription: {
    en: 'manage all your online identities and enjoy the benefits of a secure and decentralized platform based on Base Blockchain technology.',
  },
  apiLinkButton: {
    en: 'BaseTree Developer Docs',
    fa: 'مستندات API',
  },
  linkDescription: {
  ...
  linkDemoWebsiteButton: {
    en: 'BaseTree Demo link',
  },
  linkNotFound: {
    en: `You Don't own a BaseTree `,
  },
  confirming: {
    en: `Confirming TX`,
  },
  ...
  mintSuccessMsg: {
    en: 'BaseTree Registered Successfully',
  },
  onlyLinks: {
    en: 'Official Links',
  },
  ...
  testnetNotice: {
    en: 'BaseTree is live on Base Testnet !',
  },
  zealyCommunity: {
    en: 'Zealy Community',
  },
  ...
  guideStep8:{
    en: "Design Your BaseTree",
  },
  guideStep9:{
    en: "Save Your BaseTree",
  },
  guideStep10:{
    en: "Share Your BaseTree",
  },
  guideStepComplete:{
    en: "All Set 👍",
  }
